...
public class Sample8 {
...

    {
        ...
        // go back 10 month Find element by id “vfb-8”,
        // check its value, click on it
        //Find element by id “ui-datepicker-div”, create a for loop with clicking on item with
        // className “ui-datepicker-prev” Select date 15 via clicking on item with xpath “//a[text()='15']”,
        // check value of “vfb-8” against results above
    ...
    @Test
        ...
        //check text of selected item of Select (with id “vfb-12”) via
            //“getFirstSelectedOption()”, select by index 1, check the selected item text is “Option
            //1”
            WebElement dropdown = driver.findElement(By.id("vfb-12"));
            Select selector = new Select(dropdown);
            selector.getFirstSelectedOption();
