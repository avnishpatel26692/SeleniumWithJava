...
public class Sample9 {
    ...
    {
        WebDriverWait wait = new WebDriverWait(driver, 15);
        wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//p[contains(text(),'This text magicly changes color')]")));
        Assert.assertEquals("This text magicly changes color",driver.findElement(By.xpath("//p")).getText());
    }

    @Test
    public void explicitWaitExample6()
    {
        WebDriverWait wait = new WebDriverWait(driver, 15);
